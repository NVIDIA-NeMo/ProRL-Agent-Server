...
def _sanitize_openhands_mentions(text: str) -> str:
    """Sanitize @OpenHands mentions to prevent self-mention loops in GitHub."""
    return re.sub(r"@(OpenHands)\b", "@\u200d\\1", text, flags=re.IGNORECASE)
...
def main() -> int:
    ...
    sanitized = _sanitize_openhands_mentions(report)
