#!/usr/bin/env bash
# One prompt, eight trajectories, and one learner update on three batch nodes.
set -euo pipefail
...
export TMAX_TRAIN_DATA=/lustre/fsw/portfolios/nvr/projects/nvr_lpr_llm/users/junlongl/data/training_data/tmax/tmax-15k-open-instruct/polar-controller-v3-smoke.jsonl
...
export EXPERIMENT_NAME=controller-v3-smoke-3n
export WANDB_GROUP=controller-v3-smoke-3n
